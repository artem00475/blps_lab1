...
public interface OrderRepository extends JpaRepository<Orders, Long> {
    @Query("select o from Orders o join fetch o.worker w join fetch o.receiveType r join fetch o.paymentType p join fetch o.orderStatus s join fetch o.client c where o.id = ?1")
    ...
    @Query("select o from Orders o join fetch o.worker w join fetch o.receiveType r join fetch o.paymentType p join fetch o.orderStatus s join fetch o.client c")
